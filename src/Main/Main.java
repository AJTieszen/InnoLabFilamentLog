...
//		Create Button Panel
		String[] labels = {"🔎 Search", "Log new print", "Log filament brought", "Modify print", "Prepare workshop", "Show / hide NetID", "Override user info", "Refresh database", "New database", "⚙ Local settings"};
